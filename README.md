...
## Warning
It still has a lot of bugs to figure out doing anything but the simple default. I did fix some bugs so you can do values besides 89.0 dB and Undo actually works.
